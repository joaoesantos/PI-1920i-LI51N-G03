...
describe('Service-groups tests:', function() {
  it('Should return list with 3 groups', function(done) {
    ...
    let groupService = require('../../libs/CIBORG/services/groups/ciborg-services-group')(props, groupsdHttpCall, gameService, null);//tirar o null
  ...
  it('Should return a specific group:', function(done) {
    ...
    let groupService = require('../../libs/CIBORG/services/groups/ciborg-services-group')(props, groupByIdHttpCall, gameService, null);//tirar o null
  ...
  it('Should return the created group', function(done) {
    ...
    let groupService = require('../../libs/CIBORG/services/groups/ciborg-services-group')(props, createGroupHttpCall, gameService, null);//tirar o null
    let group = {
  ...
  it('Should return the updated group', function(done) {
    ...
    let groupService = require('../../libs/CIBORG/services/groups/ciborg-services-group')(props, updateGroupHttpCall, gameService, null);//tirar o null
    let group = {
  ...
  it('Should return the list of games from group', function(done) {
    ...
    let groupService = require('../../libs/CIBORG/services/groups/ciborg-services-group')(props, getGroupByIdHttpCall, gameService, null);//tirar o null
    let group = {
      id : "BXCTT24B48xg3O5SuPev",
      name : 'Test Group',
      description : "Group of wild gamers",
